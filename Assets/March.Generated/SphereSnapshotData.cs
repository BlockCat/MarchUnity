...
{
    public uint tick;
    private int MovablePlayerComponentPlayerId;
    ...
    public int GetMovablePlayerComponentPlayerId(GhostDeserializerState deserializerState)
    {
        return (int)MovablePlayerComponentPlayerId;
    }
    public int GetMovablePlayerComponentPlayerId()
    {
        return (int)MovablePlayerComponentPlayerId;
    }
    ...
    public void SetMovablePlayerComponentPlayerId(int val)
    {
        MovablePlayerComponentPlayerId = (int)val;
    }
    ...
    {
        changeMask0 = (MovablePlayerComponentPlayerId != baseline.MovablePlayerComponentPlayerId) ? 1u : 0;
        ...
        if ((changeMask0 & (1 << 0)) != 0)
            writer.WritePackedIntDelta(MovablePlayerComponentPlayerId, baseline.MovablePlayerComponentPlayerId, compressionModel);
        ...
        NetworkCompressionModel compressionModel)
    {
        ...
        if ((changeMask0 & (1 << 0)) != 0)
            MovablePlayerComponentPlayerId = reader.ReadPackedIntDelta(baseline.MovablePlayerComponentPlayerId, compressionModel);
        else
            MovablePlayerComponentPlayerId = baseline.MovablePlayerComponentPlayerId;
        if ((changeMask0 & (1 << 1)) != 0)
        {
