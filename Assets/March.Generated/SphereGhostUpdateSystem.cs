...
#pragma warning restore 649
        ...
        public ArchetypeChunkComponentType<MovablePlayerComponent> ghostMovablePlayerComponentType;
        ...
        public void Execute(ArchetypeChunk chunk, int chunkIndex, int firstEntityIndex)
        {
            ...
            var ghostMovablePlayerComponentArray = chunk.GetNativeArray(ghostMovablePlayerComponentType);
            ...
            for (int entityIndex = 0; entityIndex < ghostEntityArray.Length; ++entityIndex)
            {
                ...
                var ghostMovablePlayerComponent = ghostMovablePlayerComponentArray[entityIndex];
                var ghostRotation = ghostRotationArray[entityIndex];
                var ghostTranslation = ghostTranslationArray[entityIndex];
                ghostMovablePlayerComponent.PlayerId = snapshotData.GetMovablePlayerComponentPlayerId(deserializerState);
                ...
                ghostMovablePlayerComponentArray[entityIndex] = ghostMovablePlayerComponent;
    ...
    protected override void OnCreate()
    {
        ...
        m_interpolatedQuery = GetEntityQuery(new EntityQueryDesc
        {
            All = new []{
                ...
                ComponentType.ReadWrite<MovablePlayerComponent>(),
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostMovablePlayerComponentType = GetArchetypeChunkComponentType<MovablePlayerComponent>(),
...
public partial class SphereGhostSpawnSystem : DefaultGhostSpawnSystem<SphereSnapshotData>
{
    struct SetPredictedDefault : IJobParallelFor
    {
        ...
        {
            if (localPlayerId.Length == 1 && snapshots[index].GetMovablePlayerComponentPlayerId() == localPlayerId[0].Value)
